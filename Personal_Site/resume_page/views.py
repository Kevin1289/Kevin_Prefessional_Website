...
def home_page(request):
    ...
    language_skills = [
        ...
        {'name': 'Java', 'nameTag': 'Java', 'years': 2, 'max': 5, 'description': "Excepton Handeling, Extending/Interfacing/Nesting Classes, Threads, File IO, Networking, JDBC, Graphics"},
