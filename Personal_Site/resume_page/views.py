...
def home_page(request):
    ...
    projects = [
        {'image': '/images/personal_website.png', 'image_alt':'Personal Website', 'name': 'Professional Website (Sept 2021)', 'link': 'https://github.com/Kevin1289/Clique.io_site', 'description': 'Created a Website using Django for others to learn about my story. Used Django\'s built-in python web server. ', 'used': 'Utilized: Python, HTML, CSS.' },
